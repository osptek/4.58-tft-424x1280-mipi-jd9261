 ...
 */
typedef struct {
    const jd9261_lcd_init_cmd_t *init_cmds;    /*!< Pointer to initialization commands array.
...
} jd9261_vendor_config_t;

/**
 * @brief Create LCD panel for model JD9261
 *
 ...
 *      - Otherwise: Fail
 */
esp_err_t esp_lcd_new_panel_jd9261(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel);

/**
 * @brief LCD panel bus configuration structure
 *
 */
#define JD9261_PANEL_BUS_SPI_CONFIG(sclk, mosi, max_trans_sz)  \
    {                                                           \
        .sclk_io_num = sclk,                                    \
        .mosi_io_num = mosi,                                    \
        .miso_io_num = -1,                                      \
...
#define JD9261_PANEL_BUS_QSPI_CONFIG(sclk, d0, d1, d2, d3, max_trans_sz)\
    {                                                           \
        .sclk_io_num = sclk,                                    \
        .data0_io_num = d0,                                     \
        .data1_io_num = d1,                                     \
 ...
 *
 */
#define JD9261_PANEL_IO_3WIRE_SPI_CONFIG(line_cfg, scl_active_edge) \
    {                                                               \
 ...
 *
 */
#define JD9261_PANEL_IO_SPI_CONFIG(cs, dc, cb, cb_ctx)         \
    {                                                           \
        .cs_gpio_num = cs,                                      \
        .dc_gpio_num = dc,                                      \
        .spi_mode = 0,                                          \
...
#define JD9261_PANEL_IO_QSPI_CONFIG(cs, cb, cb_ctx)            \
    {                                                           \
        .cs_gpio_num = cs,                                      \
        .dc_gpio_num = -1,                                      \
        .spi_mode = 0,                                          \
 ...
 *
 */
#define JD9261_480_480_PANEL_60HZ_RGB_TIMING()                 \
    {                                                           \
 ...
 *
 */
#define JD9261_MIPI_PANEL_BUS_DSI_2CH_CONFIG()                \
    {                                                          \
        .bus_id = 0,                                           \
        .num_data_lanes = 2,                                   \
 ...
 *
 */
#define JD9261_MIPI_PANEL_IO_DBI_CONFIG()  \
    {                                       \
        .virtual_channel = 0,               \
        .lcd_cmd_bits = 8,                  \
        .lcd_param_bits = 8,                \
 ...
 *
 */
#define JD9261_MIPI_480_480_PANEL_60HZ_DPI_CONFIG(px_format) \
    {                                                         \
